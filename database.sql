...
UPDATE `sema`.`slider` SET `nombre`='Software', `ruta`='https://lomasbuscadoenlaweb.com/wp-content/uploads/2017/03/Una-lista-de-diferentes-tipos-de-Software-de-computadora-con-ejemplos.jpg';
